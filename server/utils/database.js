...
function initDatabase() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS zkteco_devices (
      ...
      punch_logic TEXT NOT NULL DEFAULT 'odd_even',
      user_id_map TEXT,
      last_sync_at TEXT,
      last_error TEXT,
      created_at TEXT NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS notice_board_notices (
      id TEXT PRIMARY KEY,
      title TEXT NOT NULL,
      english_pdf TEXT NOT NULL,
      arabic_pdf TEXT NOT NULL,
    ...
    CREATE INDEX IF NOT EXISTS idx_notice_board_notices_active_order
      ON notice_board_notices(active, effective_date, display_order);
